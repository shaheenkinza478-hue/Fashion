    ...
    <nav className={`sticky top-0 z-50 transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 sm:h-20">
          ...
          {/* Desktop Menu - Hidden on mobile, shown on lg+ */}
          ...
          {/* Right Icons - Adjusted for 320px */}
          <div className="flex items-center space-x-1 sm:space-x-2">
            {/* Wishlist Icon */}
            <button className="relative p-1 sm:p-2 text-gray-300 hover:text-pink-400 transition-all duration-300 hover:scale-110 group">
              <FiHeart className="text-lg sm:text-xl lg:text-2xl group-hover:fill-pink-400 transition-all duration-300" />
            ...
            {/* Account Icon */}
            <Link href="/account" className="relative p-1 sm:p-2 text-gray-300 hover:text-pink-400 transition-all duration-300 hover:scale-110 group">
              <FiUser className="text-lg sm:text-xl lg:text-2xl" />
              <span className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-gray-300 font-sans text-xs py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap border border-gray-700 hidden sm:block">
                My Account
              </span>
            </Link>
            ...
            <Link href="/cart" className="relative p-1 sm:p-2 text-gray-300 hover:text-pink-400 transition-all duration-300 hover:scale-110 group">
              <FiShoppingCart className="text-lg sm:text-xl lg:text-2xl" />
              {cartCount > 0 ? (
            ...
            <button
              ...
              className="lg:hidden relative p-1 sm:p-2 text-gray-300 hover:text-pink-400 transition-all duration-300 ml-1"
            >
              {isOpen ? (
                <FiX className="text-lg sm:text-xl animate-spin" />
              ) : (
